<?php
    ...
    function insert_doc_key_frequency(){
        ...
        $query = 'SELECT  t.ID_Document,keywords.ID_key,t.Comment_Document,keywords.Keyword
                    FROM keywords
                    INNER JOIN (SELECT  document.Comment_Document,doc_key.ID_key,doc_key.ID_Document
                                FROM document
                                INNER JOIN doc_key
